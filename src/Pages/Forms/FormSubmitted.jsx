            ...
            <div className='mx-5 bg-[#EFEBD9]'>
                {
                    ...
                    <motion.div
                        ...
                        <p><strong className='text-xl'>অনুরোধ:</strong><br />
                            ...
                            অন্য কোনো নাম্বারে পেমেন্ট করলে TMS আপনার রেজিস্ট্রেশন নিশ্চিত করতে পারবে না।
                        </p>
...

                {
                    ...
                    <motion.div
                        ...
                        <p className='font-mina'>একবার ভেরিফিকেশন সম্পন্ন হয়ে গেলে, আপনি TMS-এর পরবর্তী কার্যক্রমে সম্পূর্ণভাবে অংশগ্রহণ করতে পারবেন।
