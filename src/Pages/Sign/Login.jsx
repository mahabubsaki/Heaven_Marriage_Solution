                ...
                <form onSubmit={handleLogin} className="text-left flex justify-center  flex-col items-center text-white ">
                    ...
                    <div className='w-[350px] md:w-[400px] '>
                        <div className='flex flex-col space-y-5'>
                            <input required className='glass-morphism  placeholder:text-white py-4 w-full pl-4 pr-16 text-left outline-none rounded-sm font-raleway text-sm' placeholder='ইমেইল' type="email" name="email" />
                            <div className='relative'>
                                <input required className=' w-full placeholder:text-white  py-4 pl-4 glass-morphism pr-16 text-left outline-none rounded-sm text-sm' placeholder='পাসওয়ার্ড দিন' type={passText ? "password" : "text"} name="password" />
